const en = {
  ...
  assistant: {
    ...
    quickActions: [
      { id: "admins",    label: "Find users with Admin access", icon: "shield" },
      { id: "roles",     label: "Audit project roles",          icon: "users" },
      { id: "inactive",  label: "Spot unused permissions",      icon: "eye-off" },
      { id: "leastPriv", label: "Enforce least privilege",      icon: "lock" },
    ],
...
const fr = {
  ...
  assistant: {
    ...
    quickActions: [
      { id: "admins",    label: "Trouver les utilisateurs avec accès Admin", icon: "shield" },
      { id: "roles",     label: "Auditer les rôles de projet",               icon: "users" },
      { id: "inactive",  label: "Repérer les permissions inutilisées",       icon: "eye-off" },
      { id: "leastPriv", label: "Appliquer le moindre privilège",            icon: "lock" },
    ],
...
const es = {
  ...
  assistant: {
    ...
    quickActions: [
      { id: "admins",    label: "Encontrar usuarios con acceso Admin", icon: "shield" },
      { id: "roles",     label: "Auditar roles de proyecto",           icon: "users" },
      { id: "inactive",  label: "Detectar permisos sin uso",           icon: "eye-off" },
      { id: "leastPriv", label: "Aplicar mínimo privilegio",           icon: "lock" },
    ],
